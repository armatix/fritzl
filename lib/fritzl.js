...
class Fritzl {
    ...
    exportPKEYFromEVP_PKEY_CTX(ctx) {
    ...
    disablePinning() {
        ...
        (function () {
            ...
            var address = Module.findExportByName(this.config.binary, name);
            if (address != null) {
